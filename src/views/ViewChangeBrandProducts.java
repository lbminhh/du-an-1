 ...
 * @author LE MINH
 */
public class ViewChangeBrandProducts extends javax.swing.JDialog {

    private BrandServiceImpl brandServiceImpl = new BrandServiceImpl();
    private List<BrandResponse> list = new ArrayList<>();
    private DefaultTableModel tableModel = new DefaultTableModel();
    private int index = 0;

    /**
     * Creates new form ViewChangeBrandProducts
     */
    public ViewChangeBrandProducts(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void showDataToTable() {
        list = brandServiceImpl.getAllBrand();
        tableModel = (DefaultTableModel) tblList.getModel();
        tableModel.setRowCount(0);
        for (int i = 0; i < list.size(); i++) {
            BrandResponse item = list.get(i);
    ...
    public BrandRequest getData() {
        BrandResponse brandResponse = list.get(index);
        ...
        return new BrandRequest(id, brandName, status);
    }
    ...
    private void showItem(int index) {
        BrandResponse brandResponse = list.get(index);
        txtHang.setText(brandResponse.getBrandName());
        if (brandResponse.getStatus()) {
    ...
    private void initComponents() {
        ...
        txtHang = new components.TextField();
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(20, 20, 20))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtHang, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewChangeBrandProducts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewChangeBrandProducts dialog = new ViewChangeBrandProducts(new javax.swing.JFrame(), true);
    ...
    private components.TextField txtHang;
