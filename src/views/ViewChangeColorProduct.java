 ...
 * @author LE MINH
 */
public class ViewChangeColorProduct extends javax.swing.JDialog {
    
    private ColorServiceImpl colorServiceImpl = new ColorServiceImpl();
    private List<ColorResponse> list = new ArrayList<>();
    private DefaultTableModel tableModel = new DefaultTableModel();
    private int index = 0;

    /**
     * Creates new form ViewChangePropertiesProduct
     */
    public ViewChangeColorProduct(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void showDataToTable() {
        list = colorServiceImpl.getAllColor();
        tableModel = (DefaultTableModel) tblList.getModel();
        tableModel.setRowCount(0);
        for (int i = 0; i < list.size(); i++) {
            ColorResponse item = list.get(i);
    ...
    public ColorRequest getData() {
        ColorResponse categoryResponse = list.get(index);
        ...
        return new ColorRequest(id, txtMauSac, status);
    }
    ...
    private void showItem(int index) {
        ColorResponse colorResponse = list.get(index);
        txtMau.setText(colorResponse.getColorName());
        if (colorResponse.getStatus()) {
    ...
    private void initComponents() {
        ...
        txtMau = new components.TextField();
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(20, 20, 20))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtMau, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtMau, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewChangeColorProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewChangeColorProduct dialog = new ViewChangeColorProduct(new javax.swing.JFrame(), true);
    ...
    private components.TextField txtMau;
