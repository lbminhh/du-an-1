...
public class ViewChangSoleProduct extends javax.swing.JDialog {
     ...
     */
    public ViewChangSoleProduct(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewChangSoleProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewChangSoleProduct dialog = new ViewChangSoleProduct(new javax.swing.JFrame(), true);
